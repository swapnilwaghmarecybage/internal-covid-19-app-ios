...
struct Guide {
    static var Dos: [(title:String,imageName:String,description: String)] {return[("Hand Wash","Hand Wash","Regular hand wash for 20 seconds will help you avoid germs or any kind of infection."),
    ...
    static var Donts: [(title:String,imageName:String,description: String)] {return[("Don’t Touch Your Face","Don’t Touch Your Face","Do not touch your face, nose and mouth often. This avoids the risks of developing the virus."),
